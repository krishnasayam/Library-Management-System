        ...
        login_but.addActionListener(new ActionListener() {  //Perform action
            ...
            else if(password.equals("")) //If password is null
            {
                ...
                Statement stmt = connection.createStatement();
                  stmt.executeUpdate("USE first"); //Use the database with the name "Library"
...
//                  }
    ...
    try {
           // Class.forName("com.mysql.cj.jdbc.Driver");
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/first","root","root");
